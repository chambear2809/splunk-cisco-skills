...
LOCAL_ARTIFACT_ROOTS = [
    ...
    "widefield-security-rendered",
    "widefield-okta-integration-rendered",
    "widefield-saviynt-integration-rendered",
    "widefield-splunk-siem-rendered",
    "widefield-google-secops-rendered",
    "widefield-identity-threat-doctor-rendered",
