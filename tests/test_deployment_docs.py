...
class DeploymentDocRegressionTests(unittest.TestCase):
    ...
    def test_cloud_matrix_rows_reference_known_apps_and_workflows(self) -> None:
        ...
        self.assertIn("splunk_app_db_connect", app_rows)
        self.assertIn("Microsoft SQL Server JDBC Driver Add-on for Splunk DB Connect", app_rows)
        self.assertIn("PostgreSQL JDBC Driver Add-on for Splunk DB Connect", app_rows)
