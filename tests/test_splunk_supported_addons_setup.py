...
class SplunkSupportedAddonsSetupTests(unittest.TestCase):
    ...
    def test_generated_deployment_docs_surface_supported_addons_rows(self) -> None:
        ...
        self.assertIn("| `Splunk_TA_nix` | `splunk-supported-addons-setup` | Canonical | Required | Supported | Supported | Supported | None |", role)
        self.assertIn("| `Splunk_TA_Linux` | `splunk-supported-addons-setup` | Canonical | Required | Supported | Supported | Supported | Supported |", role)
        self.assertIn("| `splunk-salesforce-ta-setup` | 3549 |", cloud)
        self.assertIn("| `splunk-syslog-web-proxy-ta-setup` | Multiple |", cloud)
        self.assertIn("| `Splunk_TA_salesforce` | `splunk-salesforce-ta-setup` | Canonical | Required | None | Supported | None | None |", role)
        self.assertIn("| `Splunk_TA_bluecoat-proxysg` | `splunk-syslog-web-proxy-ta-setup` | Canonical | Required | Supported | Supported | Supported | Supported |", role)
        ...
        self.assertIn("| `Splunk_TA_microsoft-sqlserver` | `splunk-database-ta-setup` | Canonical | Required | Supported | Supported | Supported | None |", role)
        self.assertIn("| `TA-Exchange-ClientAccess` | `splunk-microsoft-exchange-ta-setup` | Canonical | Required | Supported | Supported | Supported | None |", role)
        self.assertIn("| `Splunk_TA_microsoft-scom` | `splunk-microsoft-scom-ta-setup` | Canonical | Required | None | Supported | None | None |", role)
        self.assertIn("| `Splunk_TA_ontap` | `splunk-netapp-ontap-ta-setup` | Canonical | Required | Supported | Supported | None | None |", role)
        self.assertIn("| `Splunk_TA_bit9-carbonblack` | `splunk-security-appliance-ta-setup` | Canonical | Required | Supported | Supported | Supported | Supported |", role)
