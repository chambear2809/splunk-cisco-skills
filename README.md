...
| `splunk-itsi-config` | Native ITSI objects and supported ITSI content packs | Preview, apply, and validate ITSI entities, services, KPIs, dependencies, NEAPs, and selected content packs from YAML specs |
