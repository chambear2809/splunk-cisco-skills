...
| I need Cisco Data Fabric architecture, readiness, or full feature/product coverage | [`cisco-data-fabric-setup`](skills/cisco-data-fabric-setup/) | `bash skills/cisco-data-fabric-setup/scripts/setup.sh --render --validate --spec skills/cisco-data-fabric-setup/template.example` |
