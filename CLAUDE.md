...
| `cisco-defenseclaw-deskside-setup` | Cisco AI Defense DefenseClaw on Linux Lemonade desksides | Install or upgrade the official Cisco release, select a local Qwen model, configure the loopback LLM endpoint, and verify the gateway with a pinned SSH host key. |
