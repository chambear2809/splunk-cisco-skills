...
| `splunk-observability-coding-agent-instrumentation-setup` | Coding-agent telemetry router | Resolve Codex or future coding-agent telemetry requests and emit non-mutating child orchestration plans for local collector, external collector, direct, or all destinations |
