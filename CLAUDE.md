...
| `galileo-mcp-server-setup` | Official Galileo MCP Server (`@galileo-ai/mcp`) | Render, validate, probe, and deep-audit safe Model Context Protocol client setup for Cursor, VS Code, Codex, Claude Code, and AWS Kiro with secret-file guardrails, live tool-schema drift checks, product-coverage gap audits, setup/validate scripts, and handoffs to Galileo platform, Agent Control, Splunk Platform HEC, and Splunk Observability workflows |
