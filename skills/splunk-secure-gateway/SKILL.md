...
description: "Use when the user asks to set up Splunk Mobile or Connected Experiences, enable or troubleshoot Splunk
  Secure Gateway, verify Spacebridge connectivity, register mobile devices, configure MDM for Splunk
  Mobile, or check mobile alert/dashboard delivery readiness. Render, preflight, and validate Splunk
  Secure Gateway and Splunk Connected Experiences (Splunk Mobile, Splunk TV, Splunk AR) readiness:
  Spacebridge outbound connectivity checks, splunk_secure_gateway app enablement, token (JWT)
  authentication readiness, device registration handoff, and an MDM AppConfig template."
...
- Set up Splunk Mobile or Connected Experiences, enable or troubleshoot Splunk Secure Gateway, verify Spacebridge
  connectivity, register mobile devices, configure MDM for Splunk Mobile, or check mobile alert/dashboard delivery
  readiness.
- Preview and review the splunk secure gateway workflow before any live apply phase.
