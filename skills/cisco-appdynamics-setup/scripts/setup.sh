...
main() {
    ...
    configure_settings
    ensure_app_visible
    log "Splunk-side index/settings setup complete; onboarding remains incomplete until a connection, input, event flow, and dashboard evidence pass validation."
    show_dashboard_index_note
