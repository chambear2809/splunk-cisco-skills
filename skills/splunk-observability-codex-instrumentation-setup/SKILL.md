...
description: "Use when instrumenting Codex itself for Splunk Observability or AI Agent Monitoring. Render, validate,
  diagnose, and safely apply Splunk Observability instrumentation for Codex CLI profiles, OTel
  destinations, JSONL runtime helpers, and optional hooks."
