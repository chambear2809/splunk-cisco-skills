...
description: "Use when the user asks about SC4SNMP, Splunk Connect for SNMP, SNMP polling, or SNMP trap ingestion
  through HEC. Deploy and validate Splunk Connect for SNMP (SC4SNMP) for Splunk Enterprise or Splunk
  Cloud. Prepares Splunk indexes and HEC, renders Docker Compose or Kubernetes Helm configuration, and
  validates SC4SNMP polling or trap readiness."
