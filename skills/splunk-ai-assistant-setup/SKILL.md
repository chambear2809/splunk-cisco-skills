...
description: "Use when the user asks about splunk-ai-assistant, Splunk AI Assistant, Splunk AI Assistant for SPL, AI
  Assistant for SPL, or the `Splunk_AI_Assistant_Cloud` app. Install, validate, and help complete Splunk
...
- Splunk-ai-assistant, Splunk AI Assistant, Splunk AI Assistant for SPL, AI Assistant for SPL, or the
  `Splunk_AI_Assistant_Cloud` app.
- Preview and review the splunk ai assistant setup workflow before any live apply phase.
...
```bash
bash skills/splunk-ai-assistant-setup/scripts/setup.sh --help
```
...
```bash
bash skills/splunk-ai-assistant-setup/scripts/validate.sh --help
```
