...
Coverage includes Transaction, Log, Browser, Mobile, Synthetic, and Connected
Devices Analytics, including IoT Analytics `Connected Device Data`, Business
Journeys, Experience Level Management (XLM), ADQL, Events API schema handling,
event publishing, and query validation.
