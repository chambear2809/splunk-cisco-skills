...
APM for AWS Lambda, Development Level Monitoring, Splunk AppDynamics for
OpenTelemetry, OTel collector/access-key validation, and app server agent
snippets. Source/runtime edits are rendered for review and not applied by this skill.
