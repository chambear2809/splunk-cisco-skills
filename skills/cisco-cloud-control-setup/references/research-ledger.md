...
| https://help.splunk.com/en/splunk-cloud-platform/apply-machine-learning/use-ai-toolkit/6.0.2/release-notes/whats-new-in-the-ai-toolkit | AI Toolkit 6.0.2 readiness basis for Data Fabric AI activation. Records that 6.0.0 introduced Agent Launchpad and that the Cisco Deep Time Series Model is "now generally available and out of preview". Retrieved 2026-08-20. |
| https://help.splunk.com/en/splunk-cloud-platform/apply-machine-learning/use-ai-toolkit/6.0.2/install-and-upgrade-the-ai-toolkit/splunk-ai-toolkit-version-dependencies | AI Toolkit to PSC version dependency table: 6.0.2 requires PSC 4.3.4 on Python 3.13, 6.0.0 accepted 4.3.2 or 4.3.3, and 4.3.2 alone maps to 5.7.4, so 6.0.2 with 4.3.2 is unsupported. Clean PSC install required on upgrade. Retrieved 2026-08-20. |
| https://help.splunk.com/en/splunk-cloud-platform/apply-machine-learning/use-ai-toolkit/6.0.2/ai-toolkit-connections-containers-and-agents/ai-toolkit-agent-launchpad | Splunk AI Toolkit Agent Launchpad GA basis; supersedes the retired Agent Builder feature preview. Kept distinct from Cloud Control Studio Agent Builder. Retrieved 2026-08-20. |
| https://help.splunk.com/en/splunk-cloud-platform/apply-machine-learning/use-ai-toolkit/6.0.2/ai-toolkit-models/cisco-deep-time-series-model | Hosted CDTSM GA basis. The 5.7.4-era "Feature preview: Cisco Deep Time Series Model" slug redirects here and the title no longer carries the preview qualifier. Retrieved 2026-08-20. |
