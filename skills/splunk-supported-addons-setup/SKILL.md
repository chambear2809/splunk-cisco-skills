...
description: "Use when the user asks for Splunk-supported add-on coverage, supported-addons gap analysis, Unix or
  Linux add-on setup, database add-ons, Microsoft Exchange, Microsoft SCOM, NetApp ONTAP, Carbon Black,
...
- The user asks for Splunk-supported add-on coverage, supported-addons gap analysis, Unix or Linux add-on setup,
  database add-ons, Microsoft Exchange, Microsoft SCOM, NetApp ONTAP, Carbon Black, Symantec Endpoint Protection,
  Splunk_TA_nix,.
- Preview and review the splunk supported addons setup workflow before any live apply phase.
...
```bash
bash skills/splunk-supported-addons-setup/scripts/setup.sh --help
```
...
```bash
bash skills/splunk-supported-addons-setup/scripts/validate.sh --help
```
