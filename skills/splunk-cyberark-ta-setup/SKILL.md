...
description: "Use when the user asks to onboard, configure, render, or validate CyberArk data in Splunk. Umbrella
  render, install, and validation workflow for CyberArk Splunk add-ons: supported CyberArk EPM API
...
- Onboard, configure, render, or validate CyberArk data in Splunk.
- Preview and review the splunk cyberark ta setup workflow before any live apply phase.
...
```bash
bash skills/splunk-cyberark-ta-setup/scripts/setup.sh --help
```
...
```bash
bash skills/splunk-cyberark-ta-setup/scripts/validate.sh --help
```
