...
description: "Use when managing ITSI entities, services, KPIs, dependencies, service trees, selected guarded
...
- Managing ITSI entities, services, KPIs, dependencies, service trees, selected guarded operations, or ITSI content-
  pack imports; do not use it to install, upgrade, license, or restart ITSI or install prerequisite apps.
- Preview and review the splunk itsi config workflow before any live apply phase.
...
```bash
bash skills/splunk-itsi-config/scripts/validate.sh --help
```
