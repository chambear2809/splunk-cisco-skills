...
SOURCE_DOCS = {
    ...
    "dashboard_savedsearch": "https://help.splunk.com/?resourceId=SplunkCloud_DashStudio_dsSavedS",
    ...
    "edge_processor_metrics": "https://help.splunk.com/en/data-management/transform-and-route-data/use-edge-processors-for-splunk-cloud-platform/monitor-system-health-and-activity/set-up-alerts-for-edge-processor-metrics",
    "ingest_processor_destinations": "https://help.splunk.com/en/splunk-cloud-platform/process-data-at-ingest-time/use-ingest-processors/monitor-system-health-and-activity/verify-your-ingest-processor-and-pipeline-configurations",
    "data_management_s3_dataset": "https://help.splunk.com/en/splunk-cloud-platform/search/federated-search/10.4.2604/run-federated-searches-over-amazon-s3-datasets/define-an-amazon-s3-dataset/create-an-amazon-s3-dataset-for-data-routing-and-federated-search",
    "data_management_azure_dataset": "https://help.splunk.com/en/splunk-cloud-platform/search/federated-search/10.4.2604/run-federated-searches-over-microsoft-azure-datasets/define-a-microsoft-azure-dataset",
    ...
    "index_retention": "https://help.splunk.com/en/splunk-enterprise/administer/update-your-deployment/10.4/troubleshooting/troubleshoot-performance-issues/change-the-index-retention-period",
    ...
    "metrics_mstats": "https://help.splunk.com/en/splunk-enterprise/search/spl-search-reference/10.4/search-commands/mstats",
    ...
    "ocsf_platform": "https://help.splunk.com/en/data-management/transform-and-route-data/use-edge-processors-for-splunk-cloud-platform/process-data-using-pipelines/convert-data-to-ocsf-format-using-an-edge-processor/working-with-ocsf-formatted-data-in-the-splunk-platform-and-splunk-enterprise-security",
...
def render_collection_searches(evidence: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "## Global: Data Management dataset readiness (Splunk Cloud 10.4.2604+)",
            "# Review Data Management app connections and datasets for Amazon S3 or Microsoft Azure routes used by Edge Processor, Ingest Processor, Federated Search for Amazon S3, or Federated Search for Microsoft Azure.",
            "# This repo does not claim private Data Management API CRUD; capture UI/API evidence of connection health, dataset family, routing mode, federated-search enablement, and required capabilities such as edit_datasets.",
            "",
