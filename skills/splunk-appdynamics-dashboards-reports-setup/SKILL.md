...
Owns dashboard, report, and War Room planning. API-backed dashboard changes can
be rendered for apply; UI-only report and War Room operations stay runbooks.
