...
| `splunk-galileo-integration` | None | None | None | None | Required | External collector | Galileo Observe to Splunk workflow orchestration: REST export to Splunk HEC, OpenTelemetry/OpenInference runtime snippets, Splunk Connect for OTLP handoff, Splunk OTel Collector handoff, and dashboard/detector handoffs. Splunk-side HEC, OTLP, OTel Collector, dashboard, and detector logic is delegated to existing skills. |
