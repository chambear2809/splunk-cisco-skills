...
| `splunk-appdynamics-setup` | None | None | None | None | None | None | AppDynamics suite router and coverage doctor; delegates product and Splunk Platform mutations to child skills. |
| `splunk-appdynamics-platform-setup` | None | None | None | None | None | None | External AppDynamics platform workflow; no Splunk app placement. |
| `splunk-appdynamics-controller-admin-setup` | None | None | None | None | None | None | External AppDynamics Controller admin workflow; no Splunk app placement. |
| `splunk-appdynamics-agent-management-setup` | None | None | None | None | None | None | External AppDynamics Smart Agent workflow; host execution is gated and no Splunk app placement is required. |
| `splunk-appdynamics-apm-setup` | None | None | None | None | None | None | External AppDynamics APM workflow; runtime installs delegate to AppDynamics agent owner skills. |
...
| `splunk-appdynamics-infrastructure-visibility-setup` | None | None | None | None | None | None | External AppDynamics Infrastructure Visibility workflow; no Splunk app placement. |
...
| `splunk-appdynamics-alerting-content-setup` | None | None | None | None | None | None | External AppDynamics alerting content workflow; no Splunk app placement. |
| `splunk-appdynamics-dashboards-reports-setup` | None | None | None | None | None | None | External AppDynamics dashboard/report workflow; no Splunk app placement. |
...
| `splunk-appdynamics-security-ai-setup` | None | None | None | None | None | None | External AppDynamics security and AI workflow; delegates GPU and Cisco AI Pod handoffs where needed. |
| `splunk-appdynamics-sap-agent-setup` | None | None | None | None | None | None | External AppDynamics SAP Agent workflow; SAP changes are rendered as runbooks. |
